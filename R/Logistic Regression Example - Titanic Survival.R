#
# Logistic Regression Example - Titanic Survival
#
# Code copied directly from from:
# https://www.hackerearth.com/blog/machine-learning/practical-guide-logistic-regression-analysis-r/
#
# 4/2/2019 - Jeff Smith
#
...
train <- fread("../data/titanic_train.csv",na.strings = c(""," ",NA,"NA"))
test <- fread("../data/titanic_test.csv",na.strings = c(""," ",NA,"NA"))
